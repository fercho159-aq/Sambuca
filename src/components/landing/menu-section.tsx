                          ...
                          <div className="flex-grow">
                            <div className="flex justify-between items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  {category !== "Alitas y Papas" && item.name !== "Nuggets de Pollo (6 pz) + Papas" && item.name !== "Samburico" && item.name !== "Papas a la Francesa" && <p style={{ color: "#FF0000" }} className="font-semibold text-sm md:text-base whitespace-nowrap"> ̶N̶o̶ ̶D̶i̶s̶p̶o̶n̶i̶b̶l̶e̶ </p>}
                                </div>
                            </div>
